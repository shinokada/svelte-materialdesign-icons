<script>
  ...
  export let ariaLabel = 'virus off outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-virus-off-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'virus off outline';
-->
