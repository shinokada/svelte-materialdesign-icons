<script>
  ...
  export let ariaLabel = 'arrow top left bottom right bold';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-arrow-top-left-bottom-right-bold"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'arrow top left bottom right bold';
-->
