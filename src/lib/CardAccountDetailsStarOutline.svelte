<script>
  ...
  export let ariaLabel = 'card account details star outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-card-account-details-star-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'card account details star outline';
-->
