<script>
  ...
  export let ariaLabel = 'checkbox multiple marked outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-checkbox-multiple-marked-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'checkbox multiple marked outline';
-->
