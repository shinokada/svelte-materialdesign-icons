<script>
  ...
  export let ariaLabel = 'star cog outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-star-cog-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'star cog outline';
-->
