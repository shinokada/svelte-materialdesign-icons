<script>
  ...
  export let ariaLabel = 'spider outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-spider-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'spider outline';
-->
