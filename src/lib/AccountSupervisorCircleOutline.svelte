<script>
  ...
  export let ariaLabel = 'account supervisor circle outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-account-supervisor-circle-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'account supervisor circle outline';
-->
