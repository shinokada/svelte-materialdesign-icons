<script>
  ...
  export let ariaLabel = 'storefront remove outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-storefront-remove-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'storefront remove outline';
-->
