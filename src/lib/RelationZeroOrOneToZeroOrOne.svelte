<script>
  ...
  export let ariaLabel = 'relation zero or one to zero or one';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-relation-zero-or-one-to-zero-or-one"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'relation zero or one to zero or one';
-->
