<script>
  ...
  export let ariaLabel = 'battery charging wireless outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-battery-charging-wireless-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'battery charging wireless outline';
-->
