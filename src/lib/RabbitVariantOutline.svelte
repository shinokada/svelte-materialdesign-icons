<script>
  ...
  export let ariaLabel = 'rabbit variant outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-rabbit-variant-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'rabbit variant outline';
-->
