<script>
  ...
  export let ariaLabel = 'wall sconce flat variant outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-wall-sconce-flat-variant-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'wall sconce flat variant outline';
-->
