<script>
  ...
  export let ariaLabel = 'relation only one to one or many';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-relation-only-one-to-one-or-many"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'relation only one to one or many';
-->
