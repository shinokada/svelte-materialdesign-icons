<script>
  ...
  export let ariaLabel = 'shield link variant';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-shield-link-variant"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'shield link variant';
-->
