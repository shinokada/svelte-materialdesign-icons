<script>
  ...
  export let ariaLabel = 'arrow bottom right thin circle outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-arrow-bottom-right-thin-circle-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'arrow bottom right thin circle outline';
-->
