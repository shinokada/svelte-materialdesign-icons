<script>
  ...
  export let ariaLabel = 'wind power outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-wind-power-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'wind power outline';
-->
