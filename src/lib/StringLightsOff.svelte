<script>
  ...
  export let ariaLabel = 'string lights off';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-string-lights-off"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'string lights off';
-->
