<script>
  ...
  export let ariaLabel = 'microsoft xbox controller battery empty';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-microsoft-xbox-controller-battery-empty"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'microsoft xbox controller battery empty';
-->
