<script>
  ...
  export let ariaLabel = 'contactless payment circle outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-contactless-payment-circle-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'contactless payment circle outline';
-->
