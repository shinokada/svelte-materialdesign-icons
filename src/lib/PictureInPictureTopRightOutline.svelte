<script>
  ...
  export let ariaLabel = 'picture in picture top right outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-picture-in-picture-top-right-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'picture in picture top right outline';
-->
