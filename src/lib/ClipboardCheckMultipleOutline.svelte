<script>
  ...
  export let ariaLabel = 'clipboard check multiple outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-clipboard-check-multiple-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'clipboard check multiple outline';
-->
