<script>
  ...
  export let ariaLabel = 'receipt text arrow right outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-receipt-text-arrow-right-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'receipt text arrow right outline';
-->
