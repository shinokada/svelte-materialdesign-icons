<script>
  ...
  export let ariaLabel = 'sort alphabetical ascending variant';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-sort-alphabetical-ascending-variant"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'sort alphabetical ascending variant';
-->
