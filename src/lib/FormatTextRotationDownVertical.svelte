<script>
  ...
  export let ariaLabel = 'format text rotation down vertical';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-format-text-rotation-down-vertical"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'format text rotation down vertical';
-->
