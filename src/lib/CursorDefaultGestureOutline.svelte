<script>
  ...
  export let ariaLabel = 'cursor default gesture outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-cursor-default-gesture-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'cursor default gesture outline';
-->
