<script>
  ...
  export let ariaLabel = 'weather partly snowy';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-weather-partly-snowy"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'weather partly snowy';
-->
