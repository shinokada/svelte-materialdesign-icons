<script>
  ...
  export let ariaLabel = 'image filter center focus strong';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-image-filter-center-focus-strong"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'image filter center focus strong';
-->
