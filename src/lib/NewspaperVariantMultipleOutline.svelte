<script>
  ...
  export let ariaLabel = 'newspaper variant multiple outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-newspaper-variant-multiple-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'newspaper variant multiple outline';
-->
