<script>
  ...
  export let ariaLabel = 'credit card wireless off outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-credit-card-wireless-off-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'credit card wireless off outline';
-->
