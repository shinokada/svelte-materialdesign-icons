<script>
  ...
  export let ariaLabel = 'storefront edit';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-storefront-edit"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
