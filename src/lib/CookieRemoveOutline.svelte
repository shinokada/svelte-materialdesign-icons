<script>
  ...
  export let ariaLabel = 'cookie remove outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-cookie-remove-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'cookie remove outline';
-->
