<script>
  ...
  export let ariaLabel = 'badge account horizontal outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-badge-account-horizontal-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'badge account horizontal outline';
-->
