<script>
  ...
  export let ariaLabel = 'flower pollen outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-flower-pollen-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'flower pollen outline';
-->
