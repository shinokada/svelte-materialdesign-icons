<script>
  ...
  export let ariaLabel = 'numeric 9 plus box multiple outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-numeric-9-plus-box-multiple-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'numeric 9 plus box multiple outline';
-->
