<script>
  ...
  export let ariaLabel = 'sort alphabetical descending variant';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-sort-alphabetical-descending-variant"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'sort alphabetical descending variant';
-->
