<script>
  ...
  export let ariaLabel = 'language xaml';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-language-xaml"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'language xaml';
-->
