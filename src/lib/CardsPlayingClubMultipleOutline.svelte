<script>
  ...
  export let ariaLabel = 'cards playing club multiple outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-cards-playing-club-multiple-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'cards playing club multiple outline';
-->
