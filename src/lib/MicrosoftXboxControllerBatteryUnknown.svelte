<script>
  ...
  export let ariaLabel = 'microsoft xbox controller battery unknown';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-microsoft-xbox-controller-battery-unknown"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'microsoft xbox controller battery unknown';
-->
