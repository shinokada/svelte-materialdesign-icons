<script>
  ...
  export let ariaLabel = 'truck off road off';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-truck-off-road-off"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'truck off road off';
-->
