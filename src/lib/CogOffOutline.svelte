<script>
  ...
  export let ariaLabel = 'cog off outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-cog-off-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'cog off outline';
-->
