<script>
  ...
  export let ariaLabel = 'calendar expand horizontal outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-calendar-expand-horizontal-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'calendar expand horizontal outline';
-->
