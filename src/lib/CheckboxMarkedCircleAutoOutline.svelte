<script>
  ...
  export let ariaLabel = 'checkbox marked circle auto outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-checkbox-marked-circle-auto-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'checkbox marked circle auto outline';
-->
