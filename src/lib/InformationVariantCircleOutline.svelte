<script>
  ...
  export let ariaLabel = 'information variant circle outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-information-variant-circle-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'information variant circle outline';
-->
