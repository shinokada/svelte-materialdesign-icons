<script>
  ...
  export let ariaLabel = 'file document arrow right outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-file-document-arrow-right-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'file document arrow right outline';
-->
