<script>
  ...
  export let ariaLabel = 'smoke detector variant off';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-smoke-detector-variant-off"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'smoke detector variant off';
-->
