<script>
  ...
  export let ariaLabel = 'horizontal rotate counterclockwise';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-horizontal-rotate-counterclockwise"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'horizontal rotate counterclockwise';
-->
