<script>
  ...
  export let ariaLabel = 'car lifted pickup';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-car-lifted-pickup"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'car lifted pickup';
-->
