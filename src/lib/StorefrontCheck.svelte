<script>
  ...
  export let ariaLabel = 'storefront check';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-storefront-check"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'storefront check';
-->
