<script>
  ...
  export let ariaLabel = 'projector screen variant outline';
</script>

<svg
  xmlns="http://www.w3.org/2000/svg"
  id="mdi-projector-screen-variant-outline"
  width={size}
  height={size}
  fill={color}
  {...$$restProps}
...
@prop export let ariaLabel = 'projector screen variant outline';
-->
