<script>
  ...
  const title = "Svelte Materialdesign Icons"
...
<MetaTags
  title="{title}"
  description="Materialdesign icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-materialdesign-icons.vercel.app/',
    title: "Svelte Materialdesign Icons",
    description: "Materialdesign icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-materialdesign-icons', width: 1200, height: 630, alt: "Svelte Materialdesign Icons" }],
    site_name: 'Svelte Materialdesign Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Materialdesign Icons",
    description: "Materialdesign icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-materialdesign-icons',
    imageAlt: "Svelte Materialdesign Icons"
  }} />
  
<header class="flex-none w-full mx-auto bg-white dark:bg-orange-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-orange-950 ">
    <NavBrand href="/">
    ...
    <NavUl {hidden} {divClass} {ulClass} on:click={() => setTimeout(toggle, 1)} 
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-materialdesign-icons">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-stone-800">
  ...
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    ...
    <FooterLink href="https://github.com/shinokada/svelte-materialdesign-icons/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-materialdesign-icons/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
