...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-materialdesign-icons',
        width: 1200,
        height: 630,
        alt: 'Svelte Materialdesign Icons'
      }
    ],
...
<Footer footerType="logo" class="dark:bg-fuchsia-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    >
      ...
      <FooterLink href="https://github.com/shinokada/svelte-materialdesign-icons/blob/main/LICENSE"
        >Licensing</FooterLink
      >
      <FooterLink href="https://github.com/shinokada/svelte-materialdesign-icons/"
        >GitHub</FooterLink
      >
    </FooterLinkGroup>
  </div>
